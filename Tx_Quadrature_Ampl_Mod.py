...
# Title: Tx QAM
# Description: QAM Transmitter of Audio WAV file
...
class Tx_Quadrature_Ampl_Mod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tx QAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx QAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Tx_Quadrature_Ampl_Mod")
        ...
        self.osmosdr_sink_0.set_sample_rate(120e6)
        self.osmosdr_sink_0.set_center_freq(4e6, 0)
        ...
        self.digital_qam_mod_0 = digital.qam.qam_mod(
            ...
            verbose=False,
            log=False)
        self.blocks_wavfile_source_1 = blocks.wavfile_source('/Users/phil/dev/python/sdr/preamble.wav', True)
        ...
        self.connect((self.digital_qam_mod_0, 0), (self.qtgui_freq_sink_x_0, 0))
...
def main(top_block_cls=Tx_Quadrature_Ampl_Mod, options=None):
